...
class PointCloudMapperNodeV2(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('confirmation_min_hits', 6)
        self.declare_parameter('confirmation_min_age_sec', 0.8)
        self.declare_parameter('min_avg_confidence_for_promotion', 0.65)

        # Geometry gating.
        self.declare_parameter('min_detection_depth_m', 0.25)
        self.declare_parameter('max_detection_depth_m', 6.0)
